...
export function prettyPrintCardinal(direction: T.CardinalDirection): string {
  switch (direction) {
    case T.CardinalDirection.North: return 'NORTH';
    case T.CardinalDirection.East:  return 'EAST';
    case T.CardinalDirection.South: return 'SOUTH';
    case T.CardinalDirection.West:  return 'WEST';
  }
}

export function rotationToDegrees(direction: T.RotationalDirection): number {
  switch (direction) {
...
export function cardinalToDegrees(direction: T.CardinalDirection): number {
  switch (direction) {
...
export function degreesToCardinal(deg: number): T.CardinalDirection {
...
export function forwardXDelta(direction: T.CardinalDirection): number {
  switch (direction) {
...
export function forwardYDelta(direction: T.CardinalDirection): number {
  switch (direction) {
    case T.CardinalDirection.East:
    case T.CardinalDirection.West:
      return 0;
